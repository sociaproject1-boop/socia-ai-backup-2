export function SociaLogo({ className = "" }: { className?: string }) {
  return (
    <div className={`relative flex flex-col items-center justify-center ${className}`}>
      <div className="w-24 h-24 rounded-3xl bg-gradient-to-br from-[#7C3AED] to-[#EC4899] flex items-center justify-center shadow-[0_0_40px_rgba(124,58,237,0.4)]">
      ...
      <div className="mt-4 font-black tracking-tighter text-4xl text-transparent bg-clip-text bg-gradient-to-r from-[#7C3AED] to-[#EC4899]">
        Socia
      </div>
