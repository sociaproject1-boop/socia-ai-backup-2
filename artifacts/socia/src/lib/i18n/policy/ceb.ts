...
const ceb: Policy = {
  ui: {
    ...
    agree:                  "Padayon sa Secure Checkout",
    cancel:                 "Balik",
    proceedingTo:           "Sunod, ablihan namo ang PayMongo aron makapili ka og GCash, Maya, o Card.",
    stepIndicator:          "Lakang 1 sa 2 · Polisiya sa Plano",
    learnMore:              "Tan-awa pa",
    showLess:               "Tagoa",
    securing:               "Gisiguro ang imong secure checkout…",
  },
  global: {
