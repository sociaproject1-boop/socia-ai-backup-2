    ...
    <div className="app-bg relative h-[100dvh] w-full overflow-hidden">
      ...
      <div className="mx-auto flex h-[100dvh] w-full max-w-[480px] flex-col">
        ...
        <main className="relative flex-1 overflow-hidden">
          {/* Route content stays in normal flow. The previous Framer Motion
           * route wrapper used a transformed `absolute inset-0` layer; on
           * Android Back/lazy navigation that could leave an empty black layer
           * above the new route. No transform is needed for navigation. */}
          <div key={location} className="scroll-native h-full min-h-0 overflow-hidden">
            {children}
          </div>
