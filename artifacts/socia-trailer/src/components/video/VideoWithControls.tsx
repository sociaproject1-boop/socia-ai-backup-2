...
export default function VideoWithControls() {
  ...
  return (
    <div className="relative w-full h-screen">
      ...
      {/* Export button — top-right corner, always visible in preview */}
      <div className="absolute top-3 right-3 z-50">
        <button
          onClick={openExportPage}
          className="flex items-center gap-1.5 bg-black/60 hover:bg-black/80 backdrop-blur-sm text-white/80 hover:text-white text-xs font-semibold px-3 py-2 rounded-xl border border-white/10 hover:border-white/25 transition-all"
          title="Export as MP4 (opens in new tab)"
